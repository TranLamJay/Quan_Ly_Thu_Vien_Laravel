...
<form class="pt-3" method="POST" action="">
    <div class ='form-group'>
        ...
        <input  type='text' name='id' class='form-control' id='id' placeholder='Id' value="{{ $languages->id }}">
    </div>
    <div class='form-group'>
        <label for='type_languages'>Loại Ngôn Ngữ</label>
        <input  type='text' name='type_languages' class='form-control' id='type_languages' value="{{ $languages->type_languages }}" placeholder='Loại Ngôn Ngữ'>
    </div>
