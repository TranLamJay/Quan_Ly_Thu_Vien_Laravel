...
<form class="pt-3" method="POST" action="">
    <div class ='form-group'>
        ...
        <input  type='text' name='name' class='form-control' id='name' placeholder='Tên Nhà Xuất Bản'>
    </div>
    <div class='form-group'>
        <label for='address'>Địa Chỉ</label>
        <textarea name='address' class='form-control' id='address' placeholder='Địa Chỉ'></textarea>
    </div>
