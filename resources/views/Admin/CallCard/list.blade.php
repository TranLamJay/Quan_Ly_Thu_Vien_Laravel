            ...
            <td>
                <a href="/admin/callCards/list/detail/{{  $callCard->id  }}" name = "detail" value = "detail" class="btn btn-success">
                  ...
                  <select class="form-control select-status" data-id="{{ $callCard->id }}">
                    ...
                    <option value="-1" @if ($callCard->status === -1)
                        selected
                    @endif>Hủy phiếu mượn</option>
                  </select>
                @endif
                ...
                <a onclick="removeRow(id = {{ $callCard->id }}, url='/admin/callCards/destroy')" href="" name = "delete" value = "delete" class="btn btn-danger">
